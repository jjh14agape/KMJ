...
do
	...
	python evaluate_interaction_prediction.py --dataset $network --model jodie --epoch ${idx}
    else
	python evaluate_state_change_prediction.py --dataset $network --model jodie --epoch ${idx}
    fi
    (( idx+=1 ))
done 
