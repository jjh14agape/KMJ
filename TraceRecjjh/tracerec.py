...
How to run: 
python tracerec.py --dataset=lastfm --num_path_u=15 --num_path_i=15 --aggregation_method=GRU --seed=1 --gpu=1 --project
...
parser.add_argument('--dataset', default='wikipedia', type=str, help='Network name', choices=['Beauty_5', 'video', 'yoochoosebuy', 'Douban_Movie', 'Video_Games_5','ml1m'],)
...
parser.add_argument('--aggregation_method', default='lstm',type=str, help="aggregation_method (ex, GRU, lstm, concat, transformer)")
    ...
    for j in range(train_end_idx):
        ...
        if timestamp - tbatch_start_time > tbatch_timespan:
            ...
            for i in range(len(lib.current_tbatches_user)):
                ...
                temporal_path_user = model.grab_subgraph(tbatch_userids, tbatch_times, args.len_path, args.num_path_u)
